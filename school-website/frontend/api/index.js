// Pioneer Academic School — Vercel API
...
app.get("/api", (_req, res) => {
  res.json({
    message: "Pioneer Academic School API ✅",
    school: "Pioneer Academic School",
  });
});
...
app.get("/api/teachers", (_req, res) => res.json(store.teachers));
app.get("/api/courses", (_req, res) => res.json(store.courses));
app.get("/api/notices", (_req, res) => res.json(store.notices));
app.get("/api/events", (_req, res) => res.json(store.events));
